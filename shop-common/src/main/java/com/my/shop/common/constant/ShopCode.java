...
public enum ShopCode {
    ...
    //库存记录为空
    SHOP_REDUCE_GOODS_SUCCESS(true, 20006, "扣减库存成功"),
    //创建用户成功
    SHOP_USER_CREATE_SUCCESS(true, 30000, "创建用户成功"),
    //创建用户成功
    SHOP_USER_CREATE_FAIL(false, 30005, "创建用户失败"),
    //用户账号不能为空
    ...
    //更新用户成功
    SHOP_USER_UPDATE_SUCCESS(true, 30006, "更新用户成功"),
    //更新用户失败
    SHOP_USER_UPDATE_FAIL(false, 30006, "更新用户失败"),
    //优惠券不不存在
